...
import { ReportPostPropsState } from "./props-state/report-post.tsx";
import "../css/dashboard.css";
import { Chart, registerables} from "chart.js";

class Body extends React.Component<ReportPostPropsState.Props, ReportPostPropsState.State>
{
...
export function PostReport(): JSX.Element
{
    let LOAD: boolean = false;
        ...
        return (
            <Body Navigate={navigate} cookie={cookie} setCookie={setCookies} removeCookie={removeCookie} Location={location} postId={postId}/>
        );
}