                ...
                if(this.username.current!.value.trim() !== "")
                {
                    ...
                    if(this.username.current!.value.trim().length >= this.UsernameMin)
                    {
                        ...
                        } else 
                        {
                            ...
                            const promise: Response = await fetch(`${this.API_URL}/existuser?username=${this.username.current!.value.trim()}`);
            ...
            if(this.state.cUsername === true && this.state.cPassword === true && this.repeatPasswordStatus === true && this.emailStatus === true)
            {
                (async (): Promise<void> => 
                {
                    ...
                    if(promise.ok)
                    {
                        ...
                        {
                            this.setState(() => ({ mailLoader: false }));
                        }
        ...
        render(): JSX.Element
        {
            return (
                <div className="main-index-container">
                    <div className="main-index-cardboard">
                        <div className="register-cardboard">
                            <div className="register-header">
                                <span>FIND YOUR COMMUNITY ON</span>
                    ...
                    <div className="register-container">
                        ...
                        <div className="confirmation-block">
                            ...
                            <div className="confirmation-container">
                                <div>
                                    <span>Once the email has sended</span>
                                    <span>Please wait for approval</span>
                                    <span>You will receive a email</span>
                                    <span>once your account has approved</span>
                                </div>
                            </div>
                    ...
                    <div className="sending-email-back">
                        <div className="sending-email-loader">
