...
import "../css/admin-background.css";
import "../css/admin-transition.css";
import { CSSTransition, TransitionGroup } from "react-transition-group";
import * as login from "./admin-login.tsx";
import * as Register from "./admin-register.tsx";

export namespace AdminBackground 
{
    ...
    export function Container(): JSX.Element
    {
        ...
        return (
            <div className="main-index-background-admin">
